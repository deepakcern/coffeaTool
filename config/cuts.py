...
regions_R = {"sr": {"trigger":True,"noElectron":True, "noMuon":True, "noPhoton":True,"noTau":True,"metcut":True,"nJets":True,"twobJets":True,"bmass":True,"minDphi":True,"DPhitrkpfMET":True},
